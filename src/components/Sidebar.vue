<template>
  <aside class="tw-hidden md:tw-flex tw-w-[260px] tw-flex-col tw-bg-[#f9f9f9] dark:tw-bg-[#171717] tw-fixed tw-inset-y-0 tw-left-0 tw-z-40 tw-border-r tw-border-[#e5e7eb] dark:tw-border-[#4d4d4f]" :class="{ 'tw-flex': sidebarOpen }">
    ...
    <div class="tw-flex-1 tw-overflow-y-auto tw-px-3">
      ...
      <div class="tw-space-y-0.5">
        <div
          ...
          :key="conv.id"
          class="tw-group tw-relative tw-rounded-lg tw-transition tw-duration-0"
    ...
    <div class="tw-p-2 tw-border-t tw-border-[#e5e7eb] dark:tw-border-[#4d4d4f]" data-bottom-user-menu>
      <div class="tw-flex tw-items-center tw-gap-3 tw-px-3 tw-py-2 tw-rounded-lg hover:tw-bg-[#ececf1] dark:hover:tw-bg-[#2a2a2a] tw-transition tw-duration-0 tw-cursor-pointer" @click="$emit('show-user-menu')">
      ...
      <div v-if="bottomUserMenuOpen" class="tw-absolute tw-bottom-16 tw-left-2 tw-right-2 tw-bg-white dark:tw-bg-[#40414f] tw-border tw-border-[#d1d5db] dark:tw-border-[#565869] tw-rounded-lg tw-shadow-lg tw-z-50 tw-py-1">
        ...
        <button class="tw-w-full tw-text-left tw-px-3 tw-py-2 tw-text-sm tw-text-[#0d0d0d] dark:tw-text-[#f7f7f8] hover:tw-bg-[#f5f5f5] dark:hover:tw-bg-[#525364] tw-transition tw-duration-0 tw-flex tw-items-center tw-gap-3">
          <svg class="tw-w-4 tw-h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <button class="tw-w-full tw-text-left tw-px-3 tw-py-2 tw-text-sm tw-text-[#0d0d0d] dark:tw-text-[#f7f7f8] hover:tw-bg-[#f5f5f5] dark:hover:tw-bg-[#525364] tw-transition tw-duration-0 tw-flex tw-items-center tw-gap-3" @click="$emit('show-settings')">
          <svg class="tw-w-4 tw-h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <button 
          class="tw-w-full tw-text-left tw-px-3 tw-py-2 tw-text-sm tw-text-[#0d0d0d] dark:tw-text-[#f7f7f8] hover:tw-bg-[#f5f5f5] dark:hover:tw-bg-[#525364] tw-transition tw-duration-0 tw-flex tw-items-center tw-gap-3" 
